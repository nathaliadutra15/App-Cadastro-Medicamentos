...
no frontend para o backend). No backend foi utilizado a linguagem Typescript e o Node.JS, onde a [link1](https://github.com/nathaliadutra15/apiCadastroMedicamentos) API criada está sendo consumida 
